...
class TestMealPlanUseCase(TestCase):
    ...
    def test_use_case(self, mock_date):
        ...
        # 7. You look at what your meal plan allowances are.
        meal_allowances_by_day = meal_planner.get_meal_allowances()
        expected = {
            DayOfWeek.WEDNESDAY: {
                MealType.BREAKFAST: {
        ...
        # 8. You look at your options for breakfast grains on Wednesday
        food_options = meal_planner.get_food_options(DayOfWeek.WEDNESDAY, MealType.BREAKFAST, FoodType.GRAIN)
        expected = {
        ...
        # 9. You choose 1oz of cereal for both Wednesday & Thursday
